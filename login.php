...
<div class="login-box">
  <div class="login-logo">
    <a target="_blank" href="index.php"><b>Shop</b>Management</a>
  </div>
  <!-- /.login-logo -->
  <?php
    if (isset($login_mas)) {
  ...
  <div class="login-box-body">
    ...
    <p style="padding-top: 20px;padding-bottom: 0px;margin-bottom: 0px;" align="center">Copyright &copy; <?php echo date("Y"); ?> <a target="_blank" href="https://www.techgroup.co">Tech Group</a></p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
