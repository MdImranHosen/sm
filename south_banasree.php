...
<!--SideBar End-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="south_banasree.php"><i class="glyphicon glyphicon-briefcase"></i>South Banasree</a></li>
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php 
                     ...
                     $getShopList = $po_list->getMarketShopListBanasree();
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <span style="margin-right: 5px;"><a href="south_banasree_update.php?south_banasree_updateId=<?php echo $result['id']; ?>"><i class="fa fa-edit"></i></a></span>

                    <span><a onclick="return confirm('Are you Sure to Delete!')" href="?deleteShopDataBanasree=<?php echo $result['id']; ?>"><i class="glyphicon glyphicon-trash"></i></a></span>
                  </td>
                </tr>
                 <?php } }else{
