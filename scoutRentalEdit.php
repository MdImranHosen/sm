<?php 
  ...
  if (!isset($_GET['scoutRentalEditId']) || $_GET['scoutRentalEditId'] == NULL) {
      header("Location:index.php");
 } else{
   # $id = preg_replace('/[^-a-zA-Z0-9_]/', '', $_GET['scoutRentalEditId']);
   if( $id = preg_replace('/\D/', '', $_GET['scoutRentalEditId']) == false){
...
<!--SideBar End-->
  ...
  <div class="content-wrapper">
   ...
   <?php 
     $getScoutRentalId = $post->getScoutMarketRentalIdEdit($id);
                     
     if ($getScoutRentalId) {
       while ($result = $getScoutRentalId->fetch_assoc()) {
        ...
        <div class="col-lg-6 col-xs-12">
          ...
          <div class="box-body bgcolor_this">
            <form>
              ...
              <div class="form-group">
                <input type="submit" class="form-control" id="updateScout" value="submit">
              </div>
              </form>
            </div>
            <!-- /.box-body -->
